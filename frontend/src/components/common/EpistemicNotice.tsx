...
export const EpistemicNotice: React.FC<EpistemicNoticeProps> = ({
  ...
  return (
    <div className="glass-panel border border-slate-800/80 rounded-xl p-3 text-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
      ...
      {sourceCitation && (
        <span className="text-[11px] text-blue-400 font-mono whitespace-nowrap bg-blue-950/40 px-2 py-0.5 rounded border border-blue-800/40">
          {sourceCitation}
        </span>
      )}
    </div>
