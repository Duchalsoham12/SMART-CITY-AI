...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  const badgeClasses = {
    ...
    cyan: 'bg-blue-500/10 text-blue-300 border-blue-500/30',
  ...
  return (
    <div className="glass-card rounded-2xl p-5 relative overflow-hidden transition-all duration-300 hover:-translate-y-0.5 group">
      ...
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-blue-500/50 to-transparent opacity-50 group-hover:opacity-100 transition-opacity" />
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {icon && (
          <div className="w-9 h-9 rounded-xl bg-slate-800/80 border border-white/[0.08] flex items-center justify-center text-blue-400 group-hover:text-blue-300 group-hover:border-blue-500/30 group-hover:bg-blue-500/10 transition-all duration-300 shadow-inner">
            {icon}
          </div>
        )}
      </div>
      ...
      {uncertaintyInterval && (
        <div className="mt-2 inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-blue-950/40 border border-blue-500/30 text-[11px] text-blue-300 font-mono font-medium">
